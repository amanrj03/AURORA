...
export async function getFinancialMetrics(ticker) {
  ...
  try {
    ...
    console.warn(`[Yahoo Finance Scraper Warning] Failed to fetch metrics for "${ticker}":`, err.message);
    try {
      console.log(`[Yahoo Finance Scraper] Loading realistic fallback financials for "${ticker}"...`);
